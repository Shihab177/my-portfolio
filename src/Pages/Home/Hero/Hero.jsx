...
const Hero = () => {
  return (
    <div
      id="hero"
      className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-screen text-white flex justify-center flex-col-reverse  lg:flex-row lg:items-center lg:justify-between gap-8"
    >
      {/*hero-info*/}
